...
def convert_xml_to_txt(xml_filepath, output_directory):
    # Parse the XML file
    ...
    for obj in objects:
        # Extract class ID (assuming it's 0 for all objects as in the sample txt)
        class_id = "0"
...
def convert_all_xml_in_folder(source_directory, output_directory):
    ...
    for filename in os.listdir(source_directory):
        if filename.endswith(".xml"):
            ...
            converted_txt_filepath = convert_xml_to_txt(xml_filepath, output_directory)
