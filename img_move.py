...
def move_images_based_on_txt(txt_filepaths, img_directory):
    """Move images in the img_directory based on the provided txt files to train or test subdirectories."""
    ...
    train_subdir = os.path.join(img_directory, 'train')
    test_subdir = os.path.join(img_directory, 'test')
    ...
    for filename in os.listdir(img_directory):
        if filename.split('.')[0] in listed_train_images:  # We check for the filename without extension
            source_filepath = os.path.join(img_directory, filename)
...
visible_img_directory = "/home/jb/Desktop/cv/multispectral-object-detection/datasets/rgbt-ped-detection/datasets/kaist-cvpr15/img_split/visible"

# Execute the function
moved_files = move_images_based_on_txt([train_txt_path, test_txt_path], visible_img_directory)

# Paths
train_txt_path = "/home/jb/Desktop/cv/multispectral-object-detection/datasets/rgbt-ped-detection/datasets/kaist-cvpr15/imageSets/train.txt"
test_txt_path = "/home/jb/Desktop/cv/multispectral-object-detection/datasets/rgbt-ped-detection/datasets/kaist-cvpr15/imageSets/test.txt"
visible_img_directory = "/home/jb/Desktop/cv/multispectral-object-detection/datasets/rgbt-ped-detection/datasets/kaist-cvpr15/img_split/infrared"
